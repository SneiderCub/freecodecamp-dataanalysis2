...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = ((df[df.salary == ">50K"]["native-country"].value_counts() / df["native-country"].value_counts())* 100).sort_values(ascending=False).max()

    # Identify the most popular occupation for those who earn >50K in India.
    top_IN_occupation = df[df.salary == ">50K"]['occupation'].value_counts().idxmax()
